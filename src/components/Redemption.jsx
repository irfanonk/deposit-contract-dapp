          ...
          <div>
            <div>
              ...
              <a
                ...
                href={"https://polygonscan.com//tx/" + withdrawDetails.hash}
        ...
        {!data.isLendEther && (
          <div>
            <div className="">
              ...
              <p className="break-words">
                {data.paybackAmountToken.toString() / 10 ** 18} CustomToken
              </p>
            </div>
            <div className="">
              <p className="font-bold text-white underline">
                Lend CustomToken amount
              </p>{" "}
              <p className="break-words">
                {data.lendAmountToken.toString() / 10 ** 18} CustomToken
              </p>
            </div>
          </div>
        )}
      ...
      <div>
        <div>
          ...
          <div className="">
            ...
            <p className="break-words">
              {data.collateralAmount.toString() / 10 ** 18} CustomToken
            </p>
          </div>
        </div>
      </div>
