      ...
      {isLendEther ? (
        <div>
          ...
          <div className="mt-5">
            <a
              ...
              href={"https://polygonscan.com//tx/" + information.hash}
        ...
        <div>
          {isDone ? (
            <div>
              ...
              <div className="break-words mt-5">
                ...
                <a
                  ...
                  target="_blank"
                  href={"https://polygonscan.com//tx/" + lendTokenHash}
                >
                  {lendTokenHash}
                </a>
              </div>
            ...
            <div>
              <div>Lend amount: {information.amount} CustomToken</div>
            ...
            <div>
              <div className="break-words my-2">
                ...
                <a
                  ...
                  rel="noopenner noreferrer"
                  href={
                    "https://polygonscan.com//address/" + loanContractAddress
                  }
                >
                  {loanContractAddress}
                </a>
              ...
              <div className="my-2">
                Approve amount: {information.amount} CustomToken
              </div>
              <div className="my-2">
                {" "}
          ...
          <div>
              ...
              <div className="relative ml-5 group">
                ...
                >
                  {isLendEther ? (
                    ...
                    <p className="px-1">CustomToken</p>
                  )}{" "}
            ...
            {!isValidLendAmount && (
              <div className="p-0 flex justify-center items-center text-red-500">
                <AiFillWarning className="mr-2" />
                <div>Minimum lend amount 0.0001 ETH or 1 CustomToken token</div>
              </div>
            )}
            {!isEnoughFund && (
              <div className="p-0 flex justify-center items-center text-red-500">
